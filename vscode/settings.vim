...
set timeoutlen=1000          " By default timeoutlen is 1000 ms => for vim surround to work
...
" This setting is if leader is \","
" Bind C-/ to vscode commentary since calling from vscode produces double comments due to multiple cursors
" xnoremap ,/ <SID>vscodeCommentary()
" nnoremap ,/ <SID>vscodeCommentary() . '_'
...
" xnoremap <silent> ,P :<C-u>call <SID>openVSCodeCommandsInVisualMode()<CR>
